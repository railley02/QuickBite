                ...
                <div className="flex">
                  ...
                  <div className="flex-1 p-3 flex flex-col justify-between">
                    <div>
                      ...
                      {/* ✅ FIXED: Replaced nested <Link> with a clickable <div> */}
                      <div
                        role="button"
                        onClick={(e) => {
                          e.preventDefault() // Prevents the card link from firing
                          e.stopPropagation() // Prevents bubbling
                          router.push(`/cafeteria-reviews/${cafeteria.id}`)
                        }}
                        className="flex items-center gap-1 mt-1 cursor-pointer hover:opacity-80 transition-opacity w-fit"
                      >
