...
import { Home, ClipboardList, BarChart3, UtensilsCrossed, User, Plus, Edit2, X, Loader2 } from "lucide-react"
...
export default function VendorMenuPage() {
  ...
  const updateMenuItem = async () => {
    ...
    if (error) {
      ...
      setMenuItems(menuItems.map((item) => (item.id === data.id ? data : item)))
        ...
        {loading ? (
          ...
          <div className="text-center py-12">
            ...
            <button
              ...
              className="mt-4 px-6 py-2 bg-primary text-white rounded-full text-sm font-medium cursor-pointer"
            >
              Add your first item
            </button>
          </div>
            ...
            <div className="space-y-4">
              ...
              <div className="flex gap-3 pt-2">
                <button
                  ...
                  disabled={saving}
                  className="flex-1 h-12 bg-red-500 text-white font-medium rounded-xl cursor-pointer disabled:opacity-50"
                >
                ...
                <button
                  ...
                  disabled={saving}
                  className="flex-1 h-12 bg-primary text-white font-medium rounded-xl cursor-pointer disabled:opacity-50"
                >
