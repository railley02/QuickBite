  ...
  return (
    <main className="min-h-dvh bg-background flex flex-col">
      ...
      <div className="flex-1 px-6 pt-8">
        <p className="text-muted-foreground text-sm mb-6">Enter your email address to reset your password</p>
        ...
        <p className="text-center text-sm text-muted-foreground mt-4">
          Remember Password?{" "}
          <Link href="/login/stall-owner" className="text-primary hover:underline cursor-pointer">
            Login
          </Link>
        </p>
      </div>
